    ...
    return (
      <div className="max-w-5xl mx-auto rounded-2xl border border-stone-200 bg-white p-6 shadow-lg shadow-stone-200/60">
        <div className="text-center py-12">
          <div className="text-stone-600">Loading wage data...</div>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-5xl mx-auto rounded-2xl border border-stone-200 bg-white p-6 shadow-lg shadow-stone-200/60">
      ...
      <section className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="flex flex-col gap-1.5">
          <label htmlFor="salary-country" className="text-xs font-semibold uppercase tracking-wide text-stone-500">
            Country
          </label>
          <select
            id="salary-country"
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="salary-from" className="text-xs font-semibold uppercase tracking-wide text-stone-500">
            From Year
          </label>
          <select
            id="salary-from"
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="inline-flex h-9 items-center self-start rounded-lg border border-stone-200 bg-stone-100 p-0.5 text-xs" role="group" aria-label="Price mode">
            {MODES.map((m) => (
              <button
                key={m.key}
                type="button"

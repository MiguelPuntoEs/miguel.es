...
import { PPP_RATES } from "../data/ppp-rates.js";
...
function formatCurrency(value, decimals = 2) {
  ...
  // Pinned locale: the table is server-rendered and then hydrated, so the
  // runtime default would format differently on a non-English browser and
